...
export const requisitionToDb = (req: Requisition) => ({
  ...
  acknowledgedByName: req.acknowledgedByName,
  acknowledgedAt: req.acknowledgedAt,
  acknowledgeNote: req.acknowledgeNote,
...
export const normalizeReq = (row: any): Requisition => ({
  ...
  acknowledgedById: row.acknowledgedById ?? row.acknowledged_by_id ?? undefined,
  acknowledgedByName: row.acknowledgedByName ?? row.acknowledged_by_name ?? undefined,
  acknowledgedAt: row.acknowledgedAt ?? row.acknowledged_at ?? undefined,
  acknowledgeNote: row.acknowledgeNote ?? row.acknowledge_note ?? undefined,
  amountReceived: row.amountReceived ?? row.amount_received ?? undefined,
